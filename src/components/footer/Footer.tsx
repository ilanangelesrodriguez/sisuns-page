              ...
              <div className={styles.footerContainer}>
                  <div className={styles.footerRow}>
                      ...
                      <div className={styles.footerCol}>
                          ...
                          <ul className={styles.footerList}>
                              <li>
                                  <a href="" download="Resolucion_SISUNS_19_10_2023" target="_blank"><img
                                  src="" alt=""/> Resolución Vicerrectoral: SISUNS
                                  </a>
                              </li>
                              <li>
                                  <a href="" download="Ley-Transparencia" target="_blank"><img
                                  src="" alt=""/> Ley de Transparencia
                                  </a>
                              </li>
                              <li>
                                  <a href="" download="Ley-Creacion" target="_blank"><img
                                  src="" alt=""/> Ley de Creación
                                  </a>
                              </li>
                          </ul>
